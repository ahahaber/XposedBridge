 ...
 */
public interface IXpesedHookInitPackageResources extends IXpesedMod {
	/**
	...
	final class Wrapper extends XC_InitPackageResources {
		private final IXpesedHookInitPackageResources instance;
		public Wrapper(IXpesedHookInitPackageResources instance) {
